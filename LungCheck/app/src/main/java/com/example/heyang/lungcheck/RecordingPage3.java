...
public class RecordingPage3 extends Activity
{
    private Button recording,NextLocation;
    private ProgressBar progressbar=null;
    private RecordingToWav mRecorder;
    private static final java.lang.String mRecordFilePath=Environment.getExternalStorageDirectory()+"/L3.wav";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recording_page3);
        ...
        NextLocation.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RecordingPage3.this
                        , RecordingPage4.class);
