...
public class RecordingPage4 extends Activity
{
    private Button recording,NextLocation;
    private ProgressBar progressbar=null;
    private RecordingToWav mRecorder;
    private static final java.lang.String mRecordFilePath=Environment.getExternalStorageDirectory()+"/L4.wav";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recording_page4);
        ...
        NextLocation.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RecordingPage4.this
                        , RecordingPage5.class);
