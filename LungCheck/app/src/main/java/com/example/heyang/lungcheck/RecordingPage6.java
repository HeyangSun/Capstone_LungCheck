...
public class RecordingPage6 extends Activity
{
    private Button recording,NextLocation;
    private ProgressBar progressbar=null;
    private RecordingToWav mRecorder;
    private static final java.lang.String mRecordFilePath=Environment.getExternalStorageDirectory()+"/L6.wav";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recording_page6);
        ...
        NextLocation.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RecordingPage6.this
                        , RecordingPage7.class);
